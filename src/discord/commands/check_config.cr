class CheckConfig
  ...
  def call(msg, ctx)
    ...
    client.create_message(msg.channel_id,
      "Any member with the ADMINISTRATOR permission can update the configuration at https://cryptobutler.info/configuration/guild?guild_id=#{ctx[ConfigMiddleware].guild_id(msg)}",
      Discord::Embed.new(
